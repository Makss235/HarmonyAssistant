...
namespace HarmonyAssistant.Core.Skills.WeatherSkills
{
    public class WeatherSkill : Skill
    {
        public OCS WhatWeather(ICS iCS)
        {
            ...
            var probability = parser.WeatherToday.WeatherDays[0].QuatersOfDay[index].ProbabilityOfPrecipitation;
            ...
            {
                Text = parser.WeatherToday.CurrentTemperature,
            ...
            {
                Text = parser.WeatherToday.FeelingString,
                Style = TextBlockStyles.CommonTextBlockStyle,
                HorizontalAlignment = System.Windows.HorizontalAlignment.Right,
                FontSize = 14,
            ...
            {
                Text = parser.WeatherToday.FeelingTemperature,
                Style = TextBlockStyles.CommonTextBlockStyle,
                HorizontalAlignment = System.Windows.HorizontalAlignment.Right,
            ...
            {
                Text = parser.WeatherToday.AtmosphericPhenomena,
                Style= TextBlockStyles.CommonTextBlockStyle,
            ...
            {
                Text = parser.WeatherToday.HumidityString,
                Style = TextBlockStyles.CommonTextBlockStyle,
            };
            ...
            {
                Text = parser.WeatherToday.HumidityPercent,
                Style = TextBlockStyles.CommonTextBlockStyle,
                FontWeight = FontWeights.Bold,
                HorizontalAlignment = System.Windows.HorizontalAlignment.Right,
                Margin = new Thickness(7, 0, 0, 0)
            ...
            {
                Text = parser.WeatherToday.WindString,
                Style = TextBlockStyles.CommonTextBlockStyle,
            };
            ...
            {
                Text = parser.WeatherToday.WindSpeed.Split(", ")[0],
                Style = TextBlockStyles.CommonTextBlockStyle,
                FontWeight = FontWeights.Bold,
                HorizontalAlignment = System.Windows.HorizontalAlignment.Right,
                Margin = new Thickness(7, 0, 0, 0)
            ...
            {
                Text = parser.WeatherToday.CurrentCity,
                Style = TextBlockStyles.CommonTextBlockStyle,
                FontSize = 14
            };
            ...
            {
                Text = parser.WeatherToday.LastUpdateDate,
                Style = TextBlockStyles.CommonTextBlockStyle,
                FontSize = 14
            };
